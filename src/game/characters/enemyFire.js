...
function EnemyFire(scene, x, y, blockSize) {
    this.scene = scene;
...
EnemyFire.prototype = {
    ...
    init: function() {
        ...
        this.enemyForw0.src = IMG_ENEMY_3_F_STOP;
        this.enemyForw1.src = IMG_ENEMY_3_F_FEETFRONT;
        this.enemyForw2.src = IMG_ENEMY_3_F_RUN;
        this.enemyForw3.src = IMG_ENEMY_3_F_FEETBACK;
        this.enemyBackw0.src = IMG_ENEMY_3_B_STOP;
        this.enemyBackw1.src = IMG_ENEMY_3_B_FEETFRONT;
        this.enemyBackw2.src = IMG_ENEMY_3_B_RUN;
        this.enemyBackw3.src = IMG_ENEMY_3_B_FEETBACK;
